...
class OnboardingGameScript: public ScriptInstance
{
public:
	void BindFrom() { 
        GetComponent<OnboardingGameScript>(*CEO::Get<Registry>())->entity = entity;
        *this = *GetComponent<OnboardingGameScript>(*CEO::Get<Registry>()); };
	void BindTo() { *GetComponent<OnboardingGameScript>(*CEO::Get<Registry>()) = *this; };
    ...
    */
    ...
    float timer = 0.0f;          // tracks elapsed time since last slide change for click debouncing
